    ...
    public static void SeedData(this IApplicationBuilder app)
    {
        ...
        for (var i = 0; i < 100; i++)
        {
            apartments.Add(new
            {
                ...
                LastBookedOn = DateTime.UtcNow.AddYears(-3)
            });
        }

        const string sql = """
            INSERT INTO Apartment
            (Id, [Name], Description, AddressCountry, AddressState, AddressZipCode, AddressCity, AddressStreet, PriceAmount, PriceCurrency, CleaningFeeAmount, CleaningFeeCurrency, Amenities, LastBookedOnUtc)
